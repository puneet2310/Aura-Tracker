...
function Dashboard() {
  ...
  return (
      ...
      <div className="flex-1 max-w-4xl mx-auto my-8 p-6 text-black rounded-lg shadow-lg">
          ...
          <>
            ...
            {/* {userData.role === 'Faculty' && (
              <div className='flex flex-col items-center'>
                ...
                <Button
                  onClick={() => navigate('/dashboard/faculty/take-attendance')}
                  className="mt-4 bg-indigo-500 text-white py-2 px-4 rounded-lg hover:bg-indigo-800 transition duration-300 block mx-auto"
                >
                  Take Today's Attendance
                </Button>
                <Button
                  onClick={() => navigate('/dashboard/faculty/upload-assignment')}
                  className="mt-4 bg-indigo-500 text-white py-2 px-4 rounded-lg hover:bg-indigo-800 transition duration-300 block mx-auto"
                >
                  Upload Assignment
                </Button>
